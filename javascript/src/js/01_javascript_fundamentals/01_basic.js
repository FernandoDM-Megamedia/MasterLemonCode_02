///-- EXPRESIONES BÁSICAS *************************************************
console.log("**************************************************************");
console.log("Expresiones básicas ******************************************");
...
console.log("Asignaciones con operadores aritméticos");
var num = 3;
...
console.log("2. Operadors de comparación");
...
console.log("4. Operadores BITWISE");
console.log("https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators#Bitwise");

///-- DIRECTIVAS DE CONTROL *******************************************************
console.log("Directivas de control");
console.log("IF");
// if
if (3 > 0) {
  console.log("greater");
